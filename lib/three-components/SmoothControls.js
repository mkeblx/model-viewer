...
export class SmoothControls extends EventDispatcher {
    ...
    get [(_a = $upQuaternion, _b = $upQuaternionInverse, _c = $spherical, _d = $targetSpherical, _e = $previousPosition, _f = $pointerIsDown, _g = $lastPointerPosition, _h = $velocity, $dampeningFactor)]() {
